...
namespace unirefri.Controllers
{
    ...
    {
        static string union = "Server=DESKTOP-H70EI0M\\SQLEXPRESS;Database=Unirefri_BDu;Trusted_Connection=True;Integrated Security=True;";
        ...
        public IActionResult Registrar(Usuario ouser)
        {
            ...
            using (SqlConnection cnn = new SqlConnection(union))
            {
                ...
                cmr.Parameters.AddWithValue("CorreoUsuario", ouser.CorreoUsuario);
